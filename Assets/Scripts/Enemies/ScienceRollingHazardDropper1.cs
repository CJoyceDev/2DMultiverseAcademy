...
public class ScienceRollingHazardDropper : MonoBehaviour
{
    ...
    IEnumerator SpawnHazards()
    {
        while (true) 
        {
            ...
            GameObject newHazard = Instantiate(randomFallingEnemy, spawnpoint.transform.position, Quaternion.Euler(-90f, 0f, 0f));
